...
define('MAIL_FROM', 'kanboard@xxx.com');
...
define('MAIL_SMTP_USERNAME', 'user@xxx.com');
...
define('LDAP_USERNAME', 'CN=admin,OU=user,DC=inc,DC=com,DC=cn');
...
// HTTP client proxy
define('HTTP_PROXY_HOSTNAME', '10.31.1.208');
define('HTTP_PROXY_PORT', '37890');
define('HTTP_PROXY_USERNAME', 'Clash');
define('HTTP_PROXY_PASSWORD', 'u75Fm9qG');
